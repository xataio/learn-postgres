...
<Check id="priority-summary-saved">
Create the `priority_summary` table with the query above. We'll confirm it holds one row per priority with the right totals and open counts.
</Check>
