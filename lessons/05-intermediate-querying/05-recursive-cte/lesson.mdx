...
<Check id="grace-team-saved">
Create the `grace_team` table with the query above. We'll confirm it holds Grace's seven-person subtree with the right depth on each row.
</Check>
