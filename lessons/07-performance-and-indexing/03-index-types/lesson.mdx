...
<Check id="tags-gin-created">
Build the `docs_tags_gin` index above. We'll confirm a GIN index on `tags` exists on your branch — re-run the query and the plan should show a Bitmap Index Scan on it.
</Check>
