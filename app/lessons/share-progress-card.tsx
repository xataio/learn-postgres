...
import { disableBadgeShare, enableBadgeShare } from "./badge-share-actions";
        ...
        <>
          ...
          <div className="absolute right-0 top-full z-20 mt-2 w-80 max-w-[calc(100vw-3rem)] rounded-md border border-black/10 bg-white px-4 py-3 text-left shadow-lg dark:border-white/10 dark:bg-zinc-900">
            ...
            <p className="mt-1 text-xs text-zinc-500">
              Get a public link to a badge showing your progress. Anyone with
              the link can see your name, avatar, and which lessons you&apos;ve
              completed.
            </p>
            ...
            {enabled && badgePath ? (
              <>
                ...
                <p className="mt-2 text-xs text-zinc-400">
                  Disabling makes the link stop working. Re-enabling restores
                  the same link.
                </p>
              </>
            ) : (
